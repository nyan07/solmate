...
3. Pull the latest from `main` before branching:
...
4. Create the branch and confirm:

    ```
    git checkout -b <branch-name>
    ```

5. Tell the user the branch is ready and they can start working. Remind them to say something like "I'm done" or "/start-feature finish" when they want to open a PR.
