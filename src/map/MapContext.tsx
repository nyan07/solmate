...
export const MapProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <MapContext.Provider value={{ center, setCenter, cameraDistance, setCameraDistance, topBarHeight, setTopBarHeight, listOpen, setListOpen, listScrollTop, setListScrollTop }}>
      {children}
    </MapContext.Provider>
  );
};
